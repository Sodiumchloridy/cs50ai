...
class CrosswordCreator():
    ...
    def enforce_node_consistency(self):
        ...
        for domain in self.domains.keys():
                to_remove = [] # Cannot modify set during iteration
    ...
    def ac3(self, arcs=None):
        ...
        """
        # Enqueue all arcs if initial arc is empty
        if arcs == None:
            arcs = []
        ...
        while arcs:
            x, y = arcs.pop()
            if self.revise(x, y):
                # If x domain is empty after revision, there is no solution
                if not self.domains[x]:
                    return False
                # After revision, add all of x's neighbours to be checked again
    ...
    def consistent(self, assignment):
        ...
        for variable, value in assignment.items():
            ...
            # Check overlap values do not conflict
    ...
    def order_domain_values(self, var, assignment):
        ...
        sorted_list = sorted(values, key=lambda key: values[key])
        return sorted_list
    ...
    def select_unassigned_variable(self, assignment):
        ...
        result = [x for x in unassigned_variables]
